...
router.get('/traveling', (req, res) => {
  Post.findAll({
    ...
    .then((posts) => {
      const traveling_posts = posts.map((travel) =>
...
router.get('/lifestyle', (req, res) => {
  Post.findAll({
    ...
    .then((posts) => {
      const lifestyle_posts = posts.map((lifestyle) =>
        lifestyle.get({ plain: true })
      );
...
router.get('/bucketlist', (req, res) => {
  Post.findAll({
    ...
    .then((posts) => {
      const bucketlist_posts = posts.map((bucketlist) =>
        bucketlist.get({ plain: true })
      );
